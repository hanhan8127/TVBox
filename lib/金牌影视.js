//http://www.yuhelover.com/    https://www.ghw9zwp5.com     https://chuang999.com/   https://helloux9w23vc.com/  www.y5yy.com  https://www.hkybqufgh.com/
var rule = {
  title: '金牌影院',
  ...
  lazy:$js.toString(()=>{
     ...
     let json_data = JSON.parse(request('https://www.ghw9zwp5.com/api/mw-movie/anonymous/v1/video/episode/url?id='+pid+'&nid='+nid,{headers: {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36',
  ...
  一级: $js.toString(()=>{
        ...
        list.forEach((it)=>{
            url = 'https://www.ghw9zwp5.com/detail/'+it.vodId
            d.push({
              title: it.vodName,
              desc:it.vodRemarks,
              img:it.vodPic,
  ...
  搜索: $js.toString(()=>{
    ...
    't': t
      ...
      let d = []
      data.forEach(it=>{
        let reurl = 'https://www.ghw9zwp5.com/detail/'+it.vodId
        d.push({
          title: it.vodName,
          desc:it.vodVersion,
          img:it.vodPic,
